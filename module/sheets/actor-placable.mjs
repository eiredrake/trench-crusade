 ...
 * @extends {ActorSheet}
 */
export class TrenchCrusadePlaceableSheet extends ActorSheet {
  /** @override */
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      classes: ['trench-crusade', 'sheet', 'placeable'],
      actions: {
  ...
  /** @override */
  get template() {
    return `systems/trench-crusade/templates/actor/actor-placeable-sheet.hbs`;
  }
